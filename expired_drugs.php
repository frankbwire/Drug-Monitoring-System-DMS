...
<body class="text-monospace">
    ...
    <div class="container border rounded shadow-sm">
        <h4 class="text-center border rounded shadow" style="font-weight: bold; margin-top:10px;">Expired Drug Records</h4>
          <hr>
        <p style="font-size: 14px;">The table show all EXPIRED drug records available in your system. Use the delete button provided to remove a single record.</p>
        ...
        <div class="table-responsive table-bordered text-monospace" style="height: 300px;font-size: 13px;">
            <?php
            //
            $sql4="SELECT * FROM `drugs` where `expired` = 'Yes' order by `date_added` desc;";
            ...
            <table class="table table-striped table-bordered table-sm">
                ...
                <tbody>
                    ...
                    <td class="text-center"><a class="btn btn-danger btn-sm text-white" role="button" href="delete.php?expired=<?php echo $result4["drug_id"]; ?>" style="padding-top:0px;padding-bottom:0px; font-size:12px;">Delete</a></td>
                    </tr>
                </tbody>
                <?php
                };
